...
test_that("select works", {
  expect_that(names(select(poly1, "ISO2", "NAME")), equals(c("ISO2", "NAME")))
  expect_that(names(select(line1, "ISO2", "NAME")), equals(c("ISO2", "NAME")))
...
test_that("joins work", {
  expect_true(all(is.na(left_join(ws@data, d)$ent)))
  expect_true(all(is.na(left_join(ws, d)$ent)))

  ## MDS changed 2017-05-06 and 2020-05-12
